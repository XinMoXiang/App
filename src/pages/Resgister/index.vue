  ...
  <div class="register-container">
    ...
    <div class="register">
      ...
      <div class="controls">
        ...
        <span>同意协议并注册《<a @click="AgreeProtocol
        ">尚品汇用户协议</a>》</span>
        <span class="error-msg">错误提示信息</span>
      </div>
      <div class="btn">
        <button @click="userResgister">完成注册</button>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    async userResgister() {
      ...
      if (phone && code && password == password1&&password) {
        try {
          await this.$store.dispatch('getUserRegister', { phone, password, code })
